...
![Bài 1.B - Kết nối database](./images/connect_database_2.png)

### Kéo fields và data liên quan vào columns và rows

![Bài 1.B - Kéo fields và data liên quan vào columns và rows](./images/drag_relevant_fields.png)

### Config STT field để group theo từng đề tài

![Bài 1.B - Config STT field để group theo từng đề tài](./images/config_stt_field.png)

### Thiết kế Dashboard

![Bài 1.B - Thiết kế Dashboard](./images/dashboard_2.png)
