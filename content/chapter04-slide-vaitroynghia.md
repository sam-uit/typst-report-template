...
#table(
  ...
  [Mô hình], [*Centaur (Tri thức)*], [*Cobot (Sản xuất)*], [#strong[Môi trường]], [Văn phòng, nghiên cứu, sáng tạo nội dung.], [Nhà máy, dây chuyền lắp ráp, logistics.], [#strong[Sự cộng tác]], [Con người đưa khung sườn, AI viết chi tiết, con người tinh chỉnh.], [Robot làm việc ngay bên cạnh công nhân, hỗ trợ việc nặng nhọc/đòi hỏi
chính xác cao.], [#strong[Giá trị cốt lõi]], [Tối ưu hóa tư duy chiến lược.], [Tối ưu hóa sự an toàn và hiệu suất vật lý.]
)
```
