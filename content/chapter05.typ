...
<phan-e-phan-tich-rui-ro>


== Các Câu Hỏi
<cac-cau-hoi>

- #strong[Thông tin nhạy cảm có thể tồn tại trong RAM.]
...
- #strong[Tiến trình không rõ gây nguy hiểm thế nào.]
...
- #strong[Dump file có thể bị hacker sử dụng để thu thập dữ liệu gì.]
...
- #strong[Vì sao laptop Sleep/Hibernate có thể lưu nhiều dữ liệu nhạy cảm?]
