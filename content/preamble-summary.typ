...
+ Phân tích hệ quả khi Account lockout threshold đặt quá thấp (ví dụ 3) đối với người dùng hợp lệ và kẻ tấn công.
+ Phân tích rủi ro khi Account lockout threshold đặt quá cao (ví dụ 50).
