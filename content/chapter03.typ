...
IPv4: - IP Address: 10.0.2.15 - Netmask: 255.255.255.0 - Gateway: 10.0.2.2

#figure(image("assets/p3-b1.png"),
  caption: [
    Phần 3. Bước 1. Kiểm tra IP
  ]
)

== Bước 2. Kiểm tra cổng đang mở bằng netstat
<buoc-2-kiem-tra-cong-dang-mo-bang-netstat>

+ Gõ: `netstat -ano`
+ Quan sát:
  - LISTENING → cổng đang mở
  - ESTABLISHED → kết nối đang hoạt động
+ Ghi lại các cổng quan trọng:
  - 22 (SSH -- nếu có)
  - 80, 443 (web)
  - 3389 (RDP)
  - 445 (SMB)
+ Nếu thấy cổng lạ → đánh dấu rủi ro.
...
#figure(image("assets/p3-b2.png"),
  caption: [
    Phần 3. Bước 2. Kiểm tra cổng đang mở bằng netstat
  ]
)

== Bước 3. Kiểm tra tường lửa Windows Defender
<buoc-3-kiem-tra-tuong-lua-windows-defender>

+ Mở Start → Windows Security.
...
#figure(image("assets/p3-b3.png"),
  caption: [
    Phần 3. Bước 3. Kiểm tra tường lửa Windows Defender
  ]
)
