...
+ #strong[Giải thích lý do Caesar dễ bị phá].
  ...
  - Có thể phân tích tần suất chữ cái của ngôn ngữ gốc (English) để phán đoán kết quả, vì ở đây là sự thay thế #emph[1 - 1]: một ký tự thay cho một ký tự khác.
+ #strong[IC hỗ trợ phá Vigenère như thế nào?]
  - IC (Chỉ số trùng hợp) đo lường xác suất lấy ra 2 ký tự ngẫu nhiên trong văn bản mà chúng giống nhau.
  - Đối với Vigenère, cái khó nhất để bẻ khóa là tìm ra #strong[độ dài của từ khóa].
...
+ #strong[Playfair xử lý chữ đôi ra sao?]
  - Playfair băm văn bản thành các cặp 2 ký tự (digraph).
  - Nếu trong mỗi cặp chữ có sự trùng nhau, thì sẽ được tách ra, và chèn vào giữa một ký tự thay thế, thường là $X$, ví dụ: $A A arrow.r A X$ và $A$ còn lại ở bên phải được chuyển sang cặp khác.
...
+ #strong[Tại sao Transposition giữ nguyên chữ nhưng thay đổi vị trí?]
