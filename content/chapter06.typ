...
+ Mô tả quy trình xử lý của người quản trị khi quan sát thấy:
  - Nhiều log 4625 liên tục cho cùng một tài khoản.
    - Xác định tài khoản (#emph[TargetUserName]): là người dùng bình thường, là quản trị, là chuyên viên cấp cao, phòng ban đặc thù (#emph[R&D]) hay là tài khoản dịch vụ, vv… nhằm xác định mức độ nghiêm trọng.
