...
<tinh-diem-trung-binh-cua-de-tai-tu-msdt>
...
#table(
  ...
  [MSDT], [TENDT], [DiemTrungBinh], [97001], [Quản lý thư viện], [8], [97002], [Nhận dạng vân tay], [8.2], [97003], [Bán đấu giá trên mạng], [7.5], [97004], [Quản lý siêu thị], [8], [97005], [Xử lý ảnh], [8.2], [97006], [Hệ giải toán thông minh], [8.333]
)
...
#table(
  columns: (1fr,) * 2,
  align: (center, left),
  [MSDT], [KetQuaDeTai], [99999], [KHONGDAT]
)
