...
Tham khảo: #link("https://learn.microsoft.com/en-us/sql/t-sql/statements/create-trigger-transact-sql?view=sql-server-ver17#instead-of")[INSTEAD OF];.
...
- MSDT 97001 không còn tồn tại trong SV\_DETAI:
...
- Kiểm tra trước khi đổi (xem bảng GV\_HDDT của 202)
...
- #strong[Yêu cầu:] Tạo Trigger thỏa mãn ràng buộc là một giáo viên muốn có học hàm Phó Giáo Sư (PGS) thì bắt buộc phải có học vị Tiến sĩ.
...
- #strong[Sự kiện:] `INSERT`, `UPDATE` (Kiểm tra khi thêm mới hoặc khi sửa học hàm).
- #strong[Logic:]
